...
まず紹介するのはバックトラック法です。ここで紹介するアルゴリズムはTODO[@LeFessant:2001:OPM:507635.507641]に基くものですが、SMLのパターンマッチに合わせて多少の改変を加えています。具体的にはタプルを追加したのと代数的データ型の各コンストラクタの引数を高々1つに制限しています。
