...
* Type: 最初の型を書く、あるいはHoleの型を調べて次の進め方を決める
...
さらにはIdrisの作者自身[Type Driven Development with Idris](https://www.manning.com/books/type-driven-development-with-idris)という本を著しています。これは無料でも読めるので是非一読下さい。既に型駆動開発を題材にした書籍があるので、本書では雰囲気を掴める程度、「型駆動開発って面白い」って思える程度に紹介していけたらなと思います。
